...
char menu (void){
	...
	system("K:\\Drive_Thru_E\\ADM\\AdmProd.exe");
	return (opc[0]);
...
void admin (char opc){
	switch(opc){
		case '0' : exit(0); break;
		case '1' : system("K:\\Drive_Thru_K\\PEDIDOS\\PEDIR"); break;
		case '2' : system("notepad K:\\Drive_Thru_K\\ARQUIVOS\\COMANDA.DAT"); break;
		case '3' : system("K:\\Drive_Thru_K\\PEDIDOS\\FILA"); break;
